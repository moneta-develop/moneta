...
#ifndef MONETA_QT_MONETAUNITS_H
#define MONETA_QT_MONETAUNITS_H
...
/** Moneta unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MonetaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MonetaUnits(QObject *parent);

    /** Moneta units.
      @note Source: https://en.moneta.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MONET,
...
typedef MonetaUnits::Unit MonetaUnit;

#endif // MONETA_QT_MONETAUNITS_H
