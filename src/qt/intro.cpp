...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/moneta"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Moneta Core"),
     ...
     * override -datadir in the moneta.conf file in the default data directory
     * (to be consistent with monetad behavior)
     */
    if(dataDir != getDefaultDataDirectory())
