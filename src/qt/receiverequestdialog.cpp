...
#include "config/moneta-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMonetaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MonetaUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMonetaURI(info));
}
