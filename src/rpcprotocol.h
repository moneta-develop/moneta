...
#ifndef MONETA_RPCPROTOCOL_H
#define MONETA_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Moneta is not connected
