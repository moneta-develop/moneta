Moneta Core version 0.9.2.1 is now available from:

  https://moneta.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MONET to 0.01 MONET
...
- Fix "Start moneta on system login"
